...
`;const se=$t("Sam","Ray","Thomas");se.subscribe(t=>{console.log(`Name: ${t}`)});const ae=document.querySelector("[data-home]"),ue=L(ae,"click");ue.subscribe(()=>{console.log("Home Clicked!")});const ce=document.querySelector("[data-todo]"),le=L(ce,"click");le.subscribe(()=>{console.log("Todo Clicked!")});
